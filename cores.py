...
if (data.mode in {'all', 'ft'}):
	data.cores += [
		...
		Core("B1046", "F9 FT Block 5"),
		Core("B1047", "F9 FT Block 5"),
		Core("B1048", "F9 FT Block 5"),
		...
		Core("B1055", "F9 FT Block 5"),
		Core("B1056", "F9 FT Block 5"),
		Core("B1057", "F9 FT Block 5"),
		Core("B1058", "F9 FT Block 5", True),
		Core("B1059", "F9 FT Block 5", True),
