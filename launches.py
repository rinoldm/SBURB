...
class Launch:
	def __init__(self, date, cores, landings = [["No attempt", True]], hop = False, RUD = False):
...
if (data.mode == 0 or data.mode == 1):
	data.launches += [
		...
		Launch("2014-04-18", ["B1006"], landings=[["Ocean", True]]),
		...
		Launch("2014-09-21", ["B1010"], landings=[["Ocean", True]]),
		
		Launch("2015-01-10", ["B1012"], landings=[["Original JRTI", False]]),
		Launch("2015-02-11", ["B1013"], landings=[["Ocean", True]]),
		Launch("2015-03-01", ["B1014"]),
		Launch("2015-04-14", ["B1015"], landings=[["Original JRTI", False]]),
		Launch("2015-04-27", ["B1016"]),
		Launch("2015-06-28", ["B1018"], RUD=True),
...
if (data.mode == 0 or data.mode == 2):
	data.launches += [
		...
		Launch("2016-04-08", ["B1021"], landings=[["OCISLY", True]]),
		...
		Launch("2016-07-18", ["B1025"], landings=[["LZ-1", True]]),
		Launch("2016-08-14", ["B1026"], landings=[["OCISLY", True]]),
		Launch("2016-09-01", ["B1028"], RUD=True),

		Launch("2017-01-14", ["B1029"], landings=[["JRTI", True]]),
		Launch("2017-02-19", ["B1031"], landings=[["LZ-1", True]]),
		...
		Launch("2017-12-15", ["B1035"], landings=[["LZ-1", True]]),
		...
		Launch("2018-12-05", ["B1050"], landings=[["LZ-1", False]]),
		#--------------------- Future launches ----------------------
		Launch("2018-12-18", ["B1054"]),

		Launch("2019-01-07", ["B1049"], landings=[["JRTI", True]]),		
		Launch("2019-01-17", ["B1051"], landings=[["OCISLY", True]]),
	]